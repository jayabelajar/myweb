...
<div class="mb-8 sm:mb-10">
    <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 text-[10px] font-mono text-emerald-400 tracking-widest uppercase mb-4">
...
<div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
    <div class="bg-zinc-900/20 border border-white/5 rounded-2xl p-5 sm:p-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('admin.blog.create') }}" class="text-xs uppercase tracking-widest text-emerald-400 hover:text-emerald-300">New Post</a>
        </div>
        <div class="space-y-4">
    ...
    <div class="bg-zinc-900/20 border border-white/5 rounded-2xl p-5 sm:p-6">
        ...
        <div class="space-y-3">
            <a href="{{ route('admin.projects.index') }}" class="flex items-center justify-between border border-white/5 rounded-xl px-4 py-3 hover:border-white/10 transition-colors">
                ...
                <span class="text-xs uppercase tracking-widest text-emerald-400">Manage</span>
            </a>
