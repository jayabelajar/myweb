...
<section class="min-h-screen flex flex-col justify-center items-center text-center">
    <div class="mb-6 px-3 py-1 border border-white/10 bg-white/5 rounded-full text-[11px] font-mono text-zinc-300">
    ...
    <h1 class="text-5xl md:text-8xl font-extrabold text-white tracking-tighter leading-none mb-8">
        Welcome to <br/> <span class="bg-gradient-to-b from-white to-zinc-500 bg-clip-text text-transparent italic">My Project.</span>
    </h1>
    ...
    <p class="text-lg md:text-xl text-zinc-400 max-w-2xl font-light leading-relaxed mb-10">
        ...
        yang fokus membangun aplikasi web modern, cepat, dan scalable menggunakan teknologi Laravel, Tailwind CSS, dan JavaScript.
    </p>
